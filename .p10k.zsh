# Generated by Powerlevel10k configuration wizard on 2025-02-09 at 06:46 UTC.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 31091.
# Wizard options: nerdfont-v3 + powerline, large icons, lean_8colors, unicode, 12h time,
# 2 lines, solid, full frame, black-ornaments, sparse, many icons, concise,
